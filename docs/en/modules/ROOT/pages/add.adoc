...
dependencies {
    implementation("com.github.stephengold:Acorus:2.0.1")
}
----
...
.. Select the "Acorus-2.0.1.jar" file.
...
.. Select the "Acorus-2.0.1-javadoc.jar" file.
.. Click on the btn:[Open] button.
.. Click on the btn:[Browse...] button to the right of "Sources:"
.. Select the "Acorus-2.0.1-sources.jar" file.
